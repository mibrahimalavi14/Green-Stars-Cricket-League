...
const faqs = [
  { q: "What is GSCL?", a: "Green Stars Cricket League (GSCL) is a grassroots cricket league based in Haripur, Pakistan. It features 8 teams competing in a fast-paced 5-over format, with a focus on discovering and nurturing local cricketing talent." },
