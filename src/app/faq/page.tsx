...
const faqs = [
  { q: "What is GSCL?", a: "Green Stars Cricket League (GSCL) is a grassroots cricket league based in Haripur, Pakistan. It features 6 teams competing in a fast-paced 5-over format, with a focus on discovering and nurturing local cricketing talent." },
  { q: "How many teams are there?", a: "GSCL currently has 6 teams: Alpha Warriors, Dragon Knights, Elite Rangers, Falcon Strikers, Legends XI, and Power Panthers." },
  { q: "What format does GSCL follow?", a: "The league follows a 5-over per side format. Each season consists of a double round-robin league stage followed by playoffs, culminating in a grand final." },
